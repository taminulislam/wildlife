...
limit.} All six detectors we trained under a single framework, scored on the same test
split under the presence criterion, at the conventional reporting threshold of 0.25 and at
the 0.10 the counting pipeline actually runs the detector at. Rows are ordered by the best
F1 either threshold achieves. That ordering is for reading, not a verdict: F1 weights
