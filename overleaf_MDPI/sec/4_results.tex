...
640\,px and confidence 0.25, ordered by F1; best per column in bold. The matching rules are
defined in \cref{sec:criterion}. \textbf{Animals Found} is different in kind from the other
columns: it counts \emph{animals} rather than boxes, the fraction of the 235 annotated
individuals the detector fires on in at least one frame.\label{tab:detectors}}
\begin{adjustwidth}{-\extralength}{0cm}
\centering\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabularx}{\fulllength}{lCCCCCCCCC}
\toprule
\textbf{Model} & \textbf{AP$_\mathbf{50}$} & \textbf{F1 (IoU$\geq$.50)} & \textbf{F1 (IoU$\geq$.30)} & \textbf{F1 (Centre)} & \textbf{Precision} & \textbf{Recall} & \textbf{F1} & \textbf{F$_\mathbf{0.5}$} & \textbf{Animals Found} \\
\midrule
