...
``---'' marks a row that is not one of them.\label{tab:ablationmain}}
\begin{adjustwidth}{-\extralength}{0cm}
\centering\footnotesize
\setlength{\tabcolsep}{4pt}
\begin{tabular}{clrcccr}
\toprule
\textbf{Pool} & \textbf{Configuration} & \textbf{Candidates} & \textbf{\reachedq} & \textbf{\primaryq} & \textbf{\countedq} & \textbf{MAE} \\
\midrule
C & \textbf{Full pipeline} (YOLO11m@640, orphans, 3-param rule) & 7008 & 74/83 & 66/83 & \textbf{55/83} & \textbf{2.38} \\
\midrule
--- & \quad detector $\to$ YOLOv9m @1280\,px (best AP$_{50}$) & 1496 & 67/83 & 62/83 & 54/83 & 2.54 \\
--- & \quad $-$ orphan recovery & 711 & 66/83 & 59/83 & 52/83 & 2.46 \\
E & \quad $+$ track-init gate removed, conf 0.02 & 18,349 & 79/83 & 69/83 & 54/83 & 2.54 \\
F & \quad $+$ NMS IoU $0.50 \to 0.90$ & 90,239 & 79/83 & 70/83 & 41/83 & 3.46 \\
G & \quad $+$ appearance re-identification & 27,679 & \textbf{82/83} & \textbf{73/83} & 52/83 & 2.69 \\
--- & \quad rule $\to$ temporal transformer & 7008 & 74/83 & 66/83 & 49/83 & 2.85 \\
\bottomrule
\end{tabular}
\end{adjustwidth}
\end{table}
