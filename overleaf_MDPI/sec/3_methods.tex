...
mistaken for something it is not. \textbf{The reported system runs with BoT-SORT's appearance
term disabled and performs no re-identification.} It associates detections into tracks within
...
out-performs a pretrained appearance backbone. We call this \emph{track association} rather
than re-identification throughout. Where appearance appears in this paper it is an
