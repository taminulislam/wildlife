...
Thermal transects carry low and drifting global contrast, so every frame is normalized with contrast-limited adaptive histogram equalisation (CLAHE)~\cite{zuiderveld1994clahe} before use, identically at training and inference and for
