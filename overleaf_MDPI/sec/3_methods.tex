...
(56\% of the corpus), TON 51, SHW 38 and MAS 15. That imbalance is not incidental: SHB is the dense-group site where most of our counting error concentrates
...
BoT-SORT~\cite{aharon2022botsort} with sparse-optical-flow global motion compensation (mandatory here, since the whole frame translates as the vehicle moves), producing candidate tracks. Only one component of the system is gradient-trained. The tracker's Kalman filter,
...
negative, while for counting it has correctly found the animal. We therefore evaluate under four matching rules: IoU$\geq$0.50, IoU$\geq$0.30, centre-in-box and \emph{any overlap}, and treat the last as the counting criterion, reporting it as presence or counting recall
