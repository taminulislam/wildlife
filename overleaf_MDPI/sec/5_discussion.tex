...
Several limits bound these claims. The corpus is 236 animals from four sites in one region and one winter, each site surveyed
on a single night so that site and survey conditions are confounded, one site contributes 56\% of them, per-site figures for the smallest site
...
threshold accepts nothing there. Deployment at a new site, or on a night unlike the training nights, requires re-fitting the threshold on labelled data from it, and how much data that takes is not something this corpus can answer.
