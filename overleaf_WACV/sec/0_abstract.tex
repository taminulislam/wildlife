...
(521,930 frames, 236 individually tracked white-tailed deer, 21,646 boxes), we benchmark 13
...
re-ranks detectors relative to a counting-appropriate criterion (5 of 12 models shift
$\geq$2 places), that 94\% of frame-level ground truth is interpolation whose drift accounts
for roughly a third of apparent detection error, and that the detector fails at
\emph{both} scale extremes --- the large end being a hole in the training distribution
