...
does help the association stage (\cref{tab:ablationmain}), merging fragments of one animal
within a video, which is a far easier problem than identifying it across sightings.
