...
Resolution is the one lever that behaves unpredictably. Doubling the input to 1280\,px helps
YOLOv9m on every metric (AP$_{50}$ 0.498 to 0.523, F1 0.547 to 0.595) and hurts YOLOv10m on
every one (0.498 to 0.458, 0.543 to 0.525); at 640 the two are within 0.004 AP$_{50}$, at
1280 they diverge by 0.065. AP-small falls for both, so the extra resolution buys overall
precision and recall rather than the smallest animals.
