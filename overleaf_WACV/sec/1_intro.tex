...
\item \textbf{Two measurement findings with consequences beyond this dataset:} the
IoU$\geq$0.50 criterion re-ranks detectors relative to a counting-appropriate criterion, and
94\%-interpolated video ground truth costs roughly a third of apparent detection accuracy.
