...
deer annotated as a distinct track --- 236 animals, 21,646 boxes. Because one annotated track is one animal, the corpus supplies detection, tracking and
count ground truth simultaneously --- the property on which the decomposition below
depends.
...
confirmation respectively. \Cref{fig:funnel} gives the result: on unseen video the pipeline reaches 98.8\% of
animals, gives 88.0\% their own track, and counts 62.7\%.
